defmodule SoftBank.Currency.Conversion.Source.Fixer do
  @moduledoc """
  ...
  ### Examples
      ...
      iex> SoftBank.Currency.Conversion.Source.Fixer.load
  ...
  """
  def load do
    case HTTPotion.get(@base_endpoint, query: %{access_key: get_access_key()}) do
  ...
  defp get_access_key, do: Application.get_env(:soft_bank, :source_api_key)
  defp get_protocol, do: Application.get_env(:soft_bank, :source_protocol, @default_protocol)
end
