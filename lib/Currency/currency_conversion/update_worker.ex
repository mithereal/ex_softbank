defmodule SoftBank.Currency.Conversion.UpdateWorker do
  @moduledoc false
  ...
  @update_worker SoftBank.Currency.Conversion.UpdateWorker
  ...
  defp get_source, do: Application.get_env(:soft_bank, :source, SoftBank.Currency.Conversion.Source.Fixer)
  # Default: One Day
  @spec get_refresh_interval() :: integer
  defp get_refresh_interval, do: Application.get_env(:soft_bank, :refresh_interval, 1000 * 60 * 60 * 24)
